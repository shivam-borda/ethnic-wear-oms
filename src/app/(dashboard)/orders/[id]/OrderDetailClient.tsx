...
export default function OrderDetailClient({ order: initialOrder }: Props) {
  ...
  return (
    <>
      ...
      {isPrintModalOpen && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-2 sm:p-4 overflow-y-auto print:static print:p-0 print:bg-white">
          <div className="bg-card rounded-2xl shadow-2xl max-w-3xl w-full p-3 sm:p-6 space-y-4 relative my-4 sm:my-8 print:shadow-none print:p-0 print:m-0 print:w-full print:max-w-none print:bg-white">
            <div className="flex items-center justify-between border-b pb-3 print:hidden" style={{ borderColor: "hsl(var(--border))" }}>
              <div className="flex items-center gap-2">
                <span className="text-xl">📐</span>
                <h2 className="text-base sm:text-xl font-bold" style={{ fontFamily: "Cormorant Garamond, serif" }}>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold text-white flex items-center gap-1.5 hover:opacity-90 transition-opacity"
                ...
                <button
                  ...
                  className="px-3 py-1.5 sm:py-2 rounded-lg border text-xs sm:text-sm hover:bg-muted font-bold text-muted-foreground"
                >
                  ✕
                </button>
              </div>
